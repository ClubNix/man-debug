...
\subsection{Le programme d'exemple}

\paragraph{} On va éviter de faire les choses dans le désordre, alors reprenont
...
SEGFAULT est la fonction \mintinline{c}{strlen} qui a été définie dans le
